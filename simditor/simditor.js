(function (root, factory) {
  ...
  var AlignmentButton, BlockquoteButton, BoldButton, Button, Clipboard, CodeButton, CodePopover, ColorButton, BgColorButton, FontScaleButton, Formatter, HrButton, ImageButton, ImagePopover, IndentButton, Indentation, InputManager, ItalicButton, Keystroke, LinkButton, LinkPopover, ListButton, OrderListButton, OutdentButton, Popover, Selection, Simditor, StrikethroughButton, TableButton, TitleButton, Toolbar, UnderlineButton, UndoManager, UnorderListButton, Util,
  ...
  Simditor.i18n = {
    ...
    'en-US': {
      ...
      'fontScale': 'Font Size',
      'fontScaleXXLarge': "X X Large Size",
  ...
  BgColorButton = (function (superClass) {
    extend(BgColorButton, superClass);

    function BgColorButton() {
      return BgColorButton.__super__.constructor.apply(this, arguments);
    }

    BgColorButton.prototype.name = 'bgcolor';

    BgColorButton.prototype.icon = 'mark';

    BgColorButton.prototype.disableTag = 'pre';

    BgColorButton.prototype.menu = true;

    BgColorButton.prototype.render = function () {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return BgColorButton.__super__.render.apply(this, args);
    };

    BgColorButton.prototype.renderMenu = function () {
      $('<ul class="color-list">\n<li><a href="javascript:;"class="font-color font-color-1"></a></li>\n<li><a href="javascript:;"class="font-color font-color-2"></a></li>\n<li><a href="javascript:;"class="font-color font-color-3"></a></li>\n<li><a href="javascript:;"class="font-color font-color-4"></a></li>\n<li><a href="javascript:;"class="font-color font-color-5"></a></li>\n<li><a href="javascript:;"class="font-color font-color-6"></a></li>\n<li><a href="javascript:;"class="font-color font-color-7"></a></li>\n<li><a href="javascript:;"class="font-color font-color-8"></a></li>\n<li><a href="javascript:;"class="font-color font-color-9"></a></li>\n<li><a href="javascript:;"class="font-color font-color-10"></a></li>\n<li><a href="javascript:;"class="font-color font-color-11"></a></li>\n<li><a href="javascript:;"class="font-color font-color-12"></a></li>\n<li><a href="javascript:;"class="font-color font-color-13"></a></li>\n<li><a href="javascript:;"class="font-color font-color-14"></a></li>\n<li><a href="javascript:;"class="font-color font-color-15"></a></li>\n<li><a href="javascript:;"class="font-color font-color-16"></a></li>\n<li><a href="javascript:;"class="font-color font-color-17"></a></li>\n<li><a href="javascript:;"class="font-color font-color-18"></a></li>\n<li><a href="javascript:;"class="font-color font-color-19"></a></li>\n<li><a href="javascript:;"class="font-color font-color-20"></a></li>\n<li><a href="javascript:;"class="font-color font-color-21"></a></li>\n<li><a href="javascript:;"class="font-color font-color-22"></a></li>\n<li><a href="javascript:;"class="font-color font-color-23"></a></li>\n<li><a href="javascript:;"class="font-color font-color-default"></a></li>\n</ul>').appendTo(this.menuWrapper);
      this.menuWrapper.on('mousedown', '.color-list', function (e) {
        return false;
      });
    ...
    BgColorButton.prototype._convertRgbToHex = function (rgb) {
      var match, re, rgbToHex;
      re = /rgb\((\d+),\s?(\d+),\s?(\d+)\)/g;
      match = re.exec(rgb);
      if (!match) {
  ...
  Simditor.Toolbar.addButton(BgColorButton);
