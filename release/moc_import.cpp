...
QT_MOC_LITERAL(1, 7, 12), // "importFailed"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 13), // "importSucceed"
QT_MOC_LITERAL(4, 35, 15) // "importFromExcel"

    },
    "Import\0importFailed\0\0importSucceed\0"
    "importFromExcel"
};
...
void Import::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->importFailed(); break;
        case 1: _t->importSucceed(); break;
        case 2: _t->importFromExcel(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Import::importFailed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Import::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Import::importSucceed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Import::importFailed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Import::importSucceed()
{
