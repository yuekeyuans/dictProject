...
QT_MOC_LITERAL(3, 28, 10) // "EntryModel"

    },
    "MenuItemWidget\0itemClicked\0\0EntryModel"
};
...
void MenuItemWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemClicked((*reinterpret_cast< const EntryModel(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MenuItemWidget::*)(const EntryModel & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MenuItemWidget::itemClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MenuItemWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_MenuItemWidget.data,
    qt_meta_data_MenuItemWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void MenuItemWidget::itemClicked(const EntryModel & _t1)
{
