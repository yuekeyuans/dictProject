(function (factory) {
    ...
    var body_prototype = '\
        <div class="form-group note-form-group">\
          <label class="note-form-label">书签内容</label>\
          <input class="note-link-text form-control note-form-control  note-input" type="text" />\
        </div>\
        <div class="form-group note-form-group">\
          <label class="note-form-label">书签名称</label>\
        <input class="note-link-list form-control note-form-control note-input" type="text"/>\
        </div>';

    $.extend($.summernote.plugins, {
        'add-anchors': function (context) {
            var self = this,
                ui = $.summernote.ui,
            ...
            context.memo('button.add-anchors', function () {
                return ui.button({
            ...
            this.initialize = function () {
                ...
                var footer = '<button type="submit" href="#" class="' + buttonClass + '">设置书签</button>';
            ...
            this.show = function () {
                ...
                self.showLinkDialog(linkInfo).then(function (linkInfo) {
                    ...
                    context.invoke('editor.createAnchor', linkInfo);
                }).fail(function () {
                    context.invoke('editor.restoreRange');
                });
            };
