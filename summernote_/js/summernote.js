  ...
  _createClass(Renderer, [{
    ...
    value: function render($parent) {
      ...
      if (this.options && this.options.data) {
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(this.options.data, function (k, v) {
          $node.attr('data-' + k, v);
        });
      }
      ...
      if (this.options && this.options.dblclick) {
        $node.on('dblclick', this.options.dblclick);
      }
...
/* harmony default export */ var renderer = ({
  create: function create(markup, callback) {
    return function () {
      ...
      return new renderer_Renderer(markup, children, options, callback);
    };
  }
});
...
var ui_editable = renderer.create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>');
var statusbar = renderer.create(['<output class="note-status-output" role="status" aria-live="polite"/>', '<div class="note-statusbar" role="status">', '<div class="note-resizebar" aria-label="Resize">', '<div class="note-icon-bar"/>', '<div class="note-icon-bar"/>', '<div class="note-icon-bar"/>', '</div>', '</div>'].join(''));
...
var ui_ui = function ui(editorOptions) {
  return {
    ...
    createLayout: function createLayout($note) {
      ...
      //   ])
      // )).render();
      var $editor = editor([toolbar(), editingArea([codable(), ui_editable()]), statusbar()]).render();
...
var isSupportAmd = typeof define === 'function' && __webpack_require__(45);
/**
...
var Context_Context = /*#__PURE__*/function () {
  ...
  Context_createClass(Context, [{
    ...
    value: function _initialize() {
      ...
      window.uniqueId = this.options.id;
      this.options.func = func; // set default container for tooltips, popovers, and dialogs
...
var Editor_Editor = /*#__PURE__*/function () {
  function Editor(context) {
    ...
    this.insertUserDefRule = this.wrapCommand(function (val) {
      if (!val || val == "") {
        val = "<hr style='height:1px;border:none;border-top:1px solid #555555;'>";
      }

      var hrNode = _this.getLastRange().insertNode(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(val)[0]);
    ...
    /**
     * create anchor (command) 在 createLink 上面修改
     *
     * @param {Object} linkInfo
     */

    this.createAnchor = this.wrapCommand(function (linkInfo) {
      var linkUrl = linkInfo.url;
      var linkText = linkInfo.text;
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(anchors, function (idx, anchor) {
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(anchor).attr('name', linkUrl);
      });
      var startRange = range.createFromNodeBefore(lists.head(anchors));
      var startPoint = startRange.getStartPoint();
      var endRange = range.createFromNodeAfter(lists.last(anchors));
  ...
  Buttons_createClass(Buttons, [{
          ...
          callback: function callback($dropdown) {
            ...
            $dropdown.find('input[type=color]').each(function (idx, item) {
              external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(item).change(function () {
                var $chip = $dropdown.find('#' + external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(_this).data('event')).find('.note-color-btn').first();

                var color = _this.value.toUpperCase();
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.fontname', function () {
        ...
        return _this2.ui.buttonGroup([_this2.button({
          ...
          template: function template(item) {
            return '<span style="font-family: ' + env.validFontName(item) + '">' + _this2.lang.fontFamily[item] + '</span>';
          },
    ...
    value: function updateCurrentStyle($container) {
      ...
      if (styleInfo['font-family']) {
        ...
        $cont.find('.note-current-fontname').text(this.lang.fontFamily[fontName]).css('font-family', fontName);
      }
    ...
    value: function update() {
      ...
      if (rng.isCollapsed() && rng.isOnAnchor()) {
        ...
        if (href == null || href == undefined) {
          this.$popover.find('a').text("#" + external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(anchor).attr("name"));
          this.$popover.find('a').removeAttr("href");
        } else {
...
var summernote_bs3 = __webpack_require__(46);
